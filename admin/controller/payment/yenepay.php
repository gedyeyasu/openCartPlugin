...
class ControllerPaymentYenePay extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['yenepay_email'])) {
			$data['yenepay_email'] = $this->request->post['yenepay_email'];
		} else {
			$data['yenepay_email'] = $this->config->get('yenepay_email');
		}
	...
	private function validate() {
		...
		if (!$this->request->post['yenepay_email']) {
